...
try:
    ...
    LICENSE_TEXT_PT_BR = load_text_file("EULA_pt_BR - Eisenhower Organizing.txt", folder="EULA")
    LICENSE_TEXT_EN_US = load_text_file("EULA_en_US - Eisenhower Organizing.txt", folder="EULA")
