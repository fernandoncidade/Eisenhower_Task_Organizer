...
FILES_REL = {
    ...
    "eula_pt": Path("source") / "assets" / "EULA" / "EULA_pt_BR - Eisenhower Organizing.txt",
    "eula_en": Path("source") / "assets" / "EULA" / "EULA_en_US - Eisenhower Organizing.txt",
    ...
    "clc_pt": Path("source") / "assets" / "CLC" / "CLC_pt_BR - Eisenhower Organizing.txt",
    "clc_en": Path("source") / "assets" / "CLC" / "CLC_en_US - Eisenhower Organizing.txt",
